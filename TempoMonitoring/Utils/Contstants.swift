...
final class Constants {
    ...
    struct Localizable {
        ...
        static let PAST_DATE_24_HOURS: String = NSLocalizedString("The triage has exceeded 24 hours. You must complete the triage again", comment: "")
        ...
        static let SUITABLE: String = NSLocalizedString("Suitable", comment: "")
